...
def filter_frame(frame: np.array, filter_name: str, model: torch.nn.Module = None, simple_transforms: transforms = None, points2Prev = None, img2GrayPrev = None):
    # frame_image
    ...
    if resp_objs is not None:
        for resp_obj in resp_objs:
            ...
            landmarks = get_landmarks(input_image, model, simple_transforms)
...
if __name__ == "__main__":
    ...
    #source = "apply_filter/test/data/videos/IMG_1842.MOV" for video
    source = 0 # for webcam
